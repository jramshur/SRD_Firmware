...
*
*  RX_pin_DM_STRONG     Strong Drive 
*  RX_pin_DM_OD_HI      Open Drain, Drives High 
*  RX_pin_DM_OD_LO      Open Drain, Drives Low 
*  RX_pin_DM_RES_UP     Resistive Pull Up 
*  RX_pin_DM_RES_DWN    Resistive Pull Down 
*  RX_pin_DM_RES_UPDWN  Resistive Pull Up/Down 
*  RX_pin_DM_DIG_HIZ    High Impedance Digital 
*  RX_pin_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
...
*  
* Note:
*  Macro RX_pin_ReadPS calls this function. 
*  
*******************************************************************************/
