...
#define INTAN_REG_15_DEF    (0x8fffu)     // REG15: Individual Amp Power (Ch9-16 off)
#define INTAN_REG_16_DEF    (0x90ffu)     // REG16: Individual Amp Power (Ch17-24 off)
#define INTAN_REG_17_DEF    (0x91ffu)     // REG17: Individual Amp Power (Ch25-32 off)
