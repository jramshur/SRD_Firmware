...
#define Button_ISR_INTC_VECTOR            ((reg16 *) Button_ISR__INTC_VECT)
...
#define Button_ISR_INTC_SET_EN            ((reg8 *) Button_ISR__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the Button_ISR interrupt. */
#define Button_ISR_INTC_CLR_EN            ((reg8 *) Button_ISR__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the Button_ISR interrupt state to pending. */
#define Button_ISR_INTC_SET_PD            ((reg8 *) Button_ISR__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the Button_ISR interrupt. */
#define Button_ISR_INTC_CLR_PD            ((reg8 *) Button_ISR__INTC_CLR_PD_REG)
