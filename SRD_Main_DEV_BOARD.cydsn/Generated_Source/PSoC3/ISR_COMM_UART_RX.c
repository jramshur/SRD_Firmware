...
extern uint8 UARTBuffer[MAX_DATA_SIZE];
/* `#END` */
...
CY_ISR(ISR_COMM_UART_RX_Interrupt)
{
	...
	if(UartRXIndex > sizeof(UARTBuffer))
		UartRXIndex = 0;
...
*
*   Note calling ISR_COMM_UART_RX_Start or ISR_COMM_UART_RX_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after ISR_COMM_UART_RX_Start or ISR_COMM_UART_RX_StartEx has been called. 
