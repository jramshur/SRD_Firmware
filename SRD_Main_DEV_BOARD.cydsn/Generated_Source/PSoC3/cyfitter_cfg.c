...
#define BS_UDB_0_0_1_CONFIG_VAL ((const uint8 CYFAR *)0x00080D24u)

/* IOPINS0_0 Address: CYREG_PRT0_DR Size (bytes): 10 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x00080DA4u)

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x00080DB0u)

/* IOPINS0_3 Address: CYREG_PRT3_DR Size (bytes): 10 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x00080DB8u)

/* IOPINS0_5 Address: CYREG_PRT5_DM0 Size (bytes): 8 */
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x00080DC4u)

/* IOPINS0_6 Address: CYREG_PRT6_DR Size (bytes): 10 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x00080DCCu)

/* PHUB_CFGMEM1 Address: CYREG_PHUB_CFGMEM1_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM1_VAL ((const uint8 CYFAR *)0x00080DD8u)

/* PHUB_CFGMEM2 Address: CYREG_PHUB_CFGMEM2_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM2_VAL ((const uint8 CYFAR *)0x00080DDCu)
...
static void ClockSetup(void)
{
	...
	CY_SET_REG8((void CYXDATA *)(CYREG_CLKDIST_DCFG7_CFG0 + 0x2u), 0x19u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_REG16((void CYXDATA *)CYREG_PRT0_AMUX, 0xA040u);
	CY_SET_REG8((void CYXDATA *)CYREG_DAC0_SW3, 0x01u);
	CY_SET_REG8((void CYXDATA *)CYREG_DAC2_SW0, 0x10u);
	CY_SET_REG8((void CYXDATA *)CYREG_DAC3_SW0, 0x20u);
	CY_SET_REG8((void CYXDATA *)CYREG_DSM0_SW0, 0x90u);
	CY_SET_REG8((void CYXDATA *)CYREG_BUS_SW0, 0x20u);
