...
#define INTAN_REG_15_DEF    (0x8f0fu)     // REG15: Individual Amp Power (Ch8-11 on, 12-15 off)
#define INTAN_REG_16_DEF    (0x9000u)     // REG16: Individual Amp Power (Ch16-23 off)
#define INTAN_REG_17_DEF    (0x9100u)     // REG17: Individual Amp Power (Ch24-31 off)
