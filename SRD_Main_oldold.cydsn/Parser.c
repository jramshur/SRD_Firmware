...
//    RSOF = UartDataBuffer[0];
//    RSOF = RSOF << 8 ;
//    RSOF |= UartDataBuffer[1];
    ...
    if(CalCRC == RcvdCRC)
    {
//        sprintf(tmpstr, "SOF : [%x] ", pPkt->StartOfFrame);
//        DEBUG_UART_PutString(tmpstr);
          /*Check start of frame*/
...
//                    sprintf(tmpstr, "[%x] ", DataRcvd[Index]);
//                    DEBUG_UART_PutString(tmpstr);
//                }
...
//                DEBUG_UART_PutString(tmpstr);
            ...
            //    sprintf(tmpstr, "CH : [%x] ", ChannelNumber);
            //    DEBUG_UART_PutString(tmpstr);
