...
#include <cyfitter.h>
        ...
        #include <intrins.h>
        #define isr_2_ISR_PATCH() _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_(); _nop_();
    #endif
#endif
...
#define isr_2_INTC_VECTOR            ((reg16 *) isr_2__INTC_VECT)
