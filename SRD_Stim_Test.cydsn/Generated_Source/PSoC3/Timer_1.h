...
#if !defined(CY_Timer_v2_0_Timer_1_H)
#define CY_Timer_v2_0_Timer_1_H
...
***************************************/
    ...
    ***************************************/
    ...
    #define Timer_1_RT1_MASK                                               (0x03u << Timer_1_RT1_SHIFT)  /* Sync TC and CMP bit masks */
    #define Timer_1_SYNC                                                   (0x03u << Timer_1_RT1_SHIFT)
    #define Timer_1_SYNCDSI_SHIFT                                          0x00u
    #define Timer_1_SYNCDSI_MASK                                           (0x0Fu << Timer_1_SYNCDSI_SHIFT) /* Sync all DSI inputs */
    #define Timer_1_SYNCDSI_EN                                             (0x0Fu << Timer_1_SYNCDSI_SHIFT) /* Sync all DSI inputs */
