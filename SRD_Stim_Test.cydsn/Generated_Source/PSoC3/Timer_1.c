...
*
* Global variables:
*  Timer_1_initVar: Is modified when this function is called for the first 
...
{
    /* Disable Timer */
    #if(!Timer_1_ControlRegRemoved || Timer_1_UsingFixedFunction)    /* Remove assignment if control register is removed */  
        Timer_1_CONTROL &= ~Timer_1_CTRL_ENABLE;
    #endif  
...
*  The parameter values are defined using the #define Timer_1__B_TIMER__CM_NONE 0
...
*  Timer_1__B_TIMER__CM_RISINGEDGE  - Capture on rising edge of Capture input
*  Timer_1__B_TIMER__CM_FALLINGEDGE - Capture on falling edge of Capture input
*  Timer_1__B_TIMER__CM_EITHEREDGE  - Capture on falling edge of Capture input
* 
* Return: 
*  void
*
