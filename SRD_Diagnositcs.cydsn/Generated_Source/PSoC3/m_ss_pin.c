...
*
*  m_ss_pin_DM_STRONG     Strong Drive 
*  m_ss_pin_DM_OD_HI      Open Drain, Drives High 
*  m_ss_pin_DM_OD_LO      Open Drain, Drives Low 
*  m_ss_pin_DM_RES_UP     Resistive Pull Up 
*  m_ss_pin_DM_RES_DWN    Resistive Pull Down 
*  m_ss_pin_DM_RES_UPDWN  Resistive Pull Up/Down 
*  m_ss_pin_DM_DIG_HIZ    High Impedance Digital 
*  m_ss_pin_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
