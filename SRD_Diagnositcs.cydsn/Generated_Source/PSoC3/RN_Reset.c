...
*
*  RN_Reset_DM_STRONG     Strong Drive 
*  RN_Reset_DM_OD_HI      Open Drain, Drives High 
*  RN_Reset_DM_OD_LO      Open Drain, Drives Low 
*  RN_Reset_DM_RES_UP     Resistive Pull Up 
*  RN_Reset_DM_RES_DWN    Resistive Pull Down 
*  RN_Reset_DM_RES_UPDWN  Resistive Pull Up/Down 
*  RN_Reset_DM_DIG_HIZ    High Impedance Digital 
*  RN_Reset_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
